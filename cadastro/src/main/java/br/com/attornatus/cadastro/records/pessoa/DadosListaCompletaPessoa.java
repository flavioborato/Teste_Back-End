...
public record DadosListaCompletaPessoa(Long id, String nome, String dataDeNascimento, Page<DadosListaEndereco> endereco) {

	public DadosListaCompletaPessoa(Pessoa pessoa, Page<DadosListaEndereco> endereco ) {
